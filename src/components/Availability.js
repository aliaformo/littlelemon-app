...
export default function Availability(props) {
  ...
  // useEffect that check for availability whenever the date, time or seats variables change
  React.useEffect(() => {
    if (
      props.time == "" ||
  ...
  return (
    <div>
      ...
      {/* displays not available when table not available */}
      {unAvailable && (
      ...
      {/* displays  available when table  available */}

      {props.available && (
        <div className="available-checkicon">
          <CheckCircleIcon color={"#495E57"} fontSize={"3em"}></CheckCircleIcon>
          <h2 >
            Available
          </h2>
